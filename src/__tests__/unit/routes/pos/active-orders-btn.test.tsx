...
describe('ActiveOrdersButton — click', () => {
  it('calls showModal when the anchor is clicked', () => {
    render(<ActiveOrdersButton />)
    const link = screen.getByRole('link')
  ...
  it('passes ActiveOrdersDialog component to showModal', () => {
    render(<ActiveOrdersButton />)
  ...
  it('showModal options include an onCancel callback', () => {
    render(<ActiveOrdersButton />)
    fireEvent.click(screen.getByRole('link'))
  ...
  it('does not navigate away (preventDefault called)', () => {
    ...
    // showModal was called, meaning the click handler ran and prevented default
