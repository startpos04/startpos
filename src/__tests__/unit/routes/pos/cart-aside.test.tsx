...
describe('CartAside — checkout', () => {
  it('clicking CHECKOUT calls showModal with PaymentDialog', async () => {
    const item = makeCartItem()
    render(<CartWrapper initialItems={[item]} />)
    ...
    const [Component] = vi.mocked(showModal).mock.calls[0] as any[]
    expect(Component).toBeDefined()
  })

  it('passes correct total to PaymentDialog via showModal options', async () => {
