 ...
 *
 * Tests for:
 *   src/routes/(private)/(dashboard)/(admin)/ingredients/create/index.tsx  (CreateIngredientDialog)
 *   src/routes/(private)/(dashboard)/(admin)/ingredients/$ingredientId/-edit-ingredient.tsx (EditIngredientDialog)
...
import { CreateIngredientDialog } from '@/routes/(private)/(dashboard)/(admin)/ingredients/create/index'
import { EditIngredientDialog } from '@/routes/(private)/(dashboard)/(admin)/ingredients/$ingredientId/-edit-ingredient'
...
describe('CreateIngredientDialog', () => {
  it('renders "New Ingredient" heading', async () => {
    render(<CreateIngredientDialog open={true} onClose={vi.fn()} />)
    await waitFor(() => {
  ...
  it('does not render when open=false', () => {
    render(<CreateIngredientDialog open={false} onClose={vi.fn()} />)
    expect(document.body.textContent).not.toContain('New Ingredient')
  })
})
...
describe('EditIngredientDialog', () => {
  ...
  it('does not render when open=false', () => {
    ...
    expect(document.body.textContent).not.toContain('Update Ingredient')
  })
})
