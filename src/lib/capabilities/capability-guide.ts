...
export const CAPABILITY_GUIDES: Record<string, CapabilityGuide> = {
  ...
  VIEW_ORDER_HISTORY: {
    benefits: [
      'Browse all orders created at your business',
      'Search and filter by date, customer, or status',
      'Track pending orders waiting for payment',
    ],
    steps: [
  ...
  MANAGE_PRODUCTS: {
    benefits: [
      'Build and organize your product catalogue',
      'Set prices, SKUs, and product variants',
  ...
  MANAGE_INVENTORY: {
    benefits: [
      ...
      'See stock movement history and adjustments',
    ],
    steps: [
  ...
  VIEW_INVENTORY_REPORTS: {
    benefits: [
      'See stock levels, movements, and valuations',
      'Identify fast-moving and slow-moving items',
      'Make informed restock decisions',
    ],
    steps: [
  ...
  MANAGE_SUPPLIERS: {
    benefits: [
      'Keep all supplier contacts in one place',
  ...
  CREATE_PURCHASE: {
    benefits: [
      ...
      'Maintain accurate records of what you ordered',
    ],
    steps: [
  ...
  MANAGE_EMPLOYEES: {
    benefits: [
      ...
      'Track employee activity across branches',
    ],
    steps: [
  ...
  VIEW_SALES_REPORTS: {
    benefits: [
      'Understand your revenue, margins, and trends',
  ...
  VIEW_ANALYTICS: {
    benefits: [
      'Advanced insights into business performance',
      'Identify trends and patterns in your sales',
  ...
  PRINT_RECEIPT: {
    benefits: [
      'Print or generate receipts for every transaction',
      'Comply with VAT and OR requirements',
      'Provide proof of purchase to customers',
    ],
    steps: [
  ...
  MANAGE_BRANCHES: {
    benefits: [
      ...
      'Track inventory and sales separately per branch',
  ...
  MANAGE_SETTINGS: {
    benefits: [
      'Configure units, categories, and business details',
      'Customize your POS and business settings',
      'Set tax rates and compliance options',
    ],
    steps: [
  ...
  MANAGE_BILLING: {
    benefits: [
      ...
      'Review transaction usage and limits',
    ],
    steps: [
  ...
  REACTIVATE_SUBSCRIPTION: {
    benefits: [
      'Resume operations after subscription expires',
      'Restore access to all your business data',
      'Continue where you left off without data loss',
    ],
    steps: [
  ...
  DELIVERY_MANAGEMENT: {
    benefits: [
      'Manage delivery orders and track drivers',
      'Coordinate deliveries from your dashboard',
      'Assign orders to specific drivers',
    ],
    steps: [
      { title: 'Coming Soon', description: 'This capability is under development and will be available soon.' },
      { title: 'Enable When Ready', description: 'Return to this page when the feature launches to enable it.' },
