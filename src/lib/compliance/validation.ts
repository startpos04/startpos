 ...
 * ```
 */
export function validateComplianceData(compliance: ComplianceData, countryCode?: string): string[] {
 ...
 * ```
 */
export function isComplianceDataComplete(compliance: ComplianceData, countryCode?: string): boolean {
