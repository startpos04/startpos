...
interface TenantContext {
   ...
   * auto-approved at creation time. Sourced from SystemConfig.AUTO_APPROVE_LOW_STOCK_REFILL
 ...
 *
 * Configurable per business via SystemConfig.AUTO_APPROVE_LOW_STOCK_REFILL (boolean,
 ...
 * SystemConfig.AUTO_APPROVE_LOW_STOCK_REFILL = false for the affected business.
 */
...
export const InventoryEngine = {
   ...
   *
   * Auto-approval behaviour is governed by SystemConfig.AUTO_APPROVE_LOW_STOCK_REFILL
  ...
  handleLowStockDetected({ variantId, currentTotal, threshold, productLink, operationalTaskCollection, ctx }: HandleLowStockDetectedParams): void {
    ...
    const now = new Date()
    // Read from SystemConfig — defaults to true when not explicitly configured.
