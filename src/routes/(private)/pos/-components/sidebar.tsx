...
export function Sidebar() {
  ...
  return (
    <nav className='w-20 flex flex-col items-center py-6 gap-6 bg-card rounded-[2rem] border border-border shadow-sm h-full'>
      ...
      {user.role !== 'CASHIER' ? (
        <div className='mt-auto pt-4 border-t border-border w-full flex justify-center'>
          <Link to='/'>
            <Button variant='ghost' className='rounded-2xl h-14 w-14'>
