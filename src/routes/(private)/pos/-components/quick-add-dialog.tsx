...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@startpos-core/components/ui/dialog'
import { categoryCollection, productCollection, productVariantCollection, unitCollection } from '@startpos-core/db/collections'
