...
import { Coffee, Database, Edit, Info, Layers, Sparkles, Trash2 } from 'lucide-react'
import numeral from 'numeral'
import { BusinessType, VariantAttributeType } from 'prisma/generated/prisma/enums'
...
function RouteComponent() {
  ...
  const handleEdit = (e: React.MouseEvent<HTMLAnchorElement>, product: posProduct) => {
    e.preventDefault()
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className='bg-popover border-border p-3 rounded-xl shadow-xl'>
                              <p className='text-[11px] font-medium text-popover-foreground'>
                                To maintain your target <span className='font-bold text-primary'>{numeral(targetMargin).format('0%')}</span> margin threshold,
                                charge this amount.
                              </p>
                            </TooltipContent>
                          </Tooltip>
