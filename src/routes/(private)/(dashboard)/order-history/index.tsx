...
import { OfflineIndicator } from '@startpos-core/components/custom/offline-indicator'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@startpos-core/components/ui/select'
import { orderCollection, orderItemCollection, paymentCollection, transactionCollection, userCollection } from '@startpos-core/db/collections'
