    ...
    <div className='px-4 pb-6 space-y-6 max-w-4xl'>
        ...
        <>
          ...
          <div className='space-y-1'>
            ...
            <p className='text-sm text-muted-foreground'>
              Manage your business registration status and tax compliance information.
            </p>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Current status of your business registration with the government.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          ...
          <div className='rounded-md border border-muted bg-muted/50 p-3 text-sm space-y-1'>
            ...
            <ul className='list-disc list-inside space-y-0.5 text-muted-foreground'>
              <li><span className='font-medium text-foreground'>UNREGISTERED:</span> Not registered with government yet</li>
              <li><span className='font-medium text-foreground'>PENDING:</span> Registration in progress</li>
              <li><span className='font-medium text-foreground'>REGISTERED:</span> Fully registered (must fill required fields below)</li>
              <li><span className='font-medium text-foreground'>EXPIRED:</span> Registration has expired and needs renewal</li>
            </ul>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your business tax identification and registration details (Philippines - BIR).
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={e => handleFieldChange('birTin', e.target.value)}
            />
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={e => handleFieldChange('rdoCode', e.target.value)}
            />
          </div>
          ...
          <div className='flex items-center justify-between rounded-lg border p-4'>
            ...
            <Switch
              ...
              onCheckedChange={checked => handleFieldChange('isVatRegistered', checked)}
            />
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Official permits and registration numbers issued by government agencies.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            <Label htmlFor='ptu-number'>
              PTU Number (Permit to Use) {formData.isVatRegistered && <span className='text-destructive'>*</span>}
            </Label>
            <Input
              id='ptu-number'
              placeholder='PTU-YYYY-NNNNN'
              value={formData.ptuNumber}
              onChange={e => handleFieldChange('ptuNumber', e.target.value)}
            />
          ...
          <div className='space-y-2'>
            ...
            <Input
              id='ptu-issue-date'
              type='date'
              value={formData.ptuIssueDate}
              onChange={e => handleFieldChange('ptuIssueDate', e.target.value)}
            />
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Branch-specific registration details for receipt printing.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
      ...
      <div className='flex flex-col sm:flex-row gap-3'>
        ...
        <Button
          ...
          disabled={isSaving || isTesting || registrationStatus !== 'REGISTERED'}
        >
          <SaveIcon className='h-4 w-4' />
