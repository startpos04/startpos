 ...
 *
 * Icon States:
 * - âš ï¸ (Yellow/Orange) = UNREGISTERED
 * - â³ (Blue) = PENDING
 * - âœ… (Green) = REGISTERED
 * - ðŸ”´ (Red) = EXPIRED
 *
    ...
    switch (registrationStatus) {
      case 'UNREGISTERED':
        return {
          ...
          tooltip: 'Business not registered â€” Click to complete',
      ...
      case 'PENDING':
        return {
          ...
          tooltip: 'Registration in progress â€” Click to complete',
      ...
      case 'EXPIRED':
        return {
          ...
          tooltip: 'Registration expired â€” Click to renew',
