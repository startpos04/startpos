...
//
// These models have no businessId/branchId fields â€” they are not tenant-scoped.
// coreAPI only operates on this set. Attempting to call any other model name
// is rejected at runtime by both server functions.
//
// Read operations are PUBLIC (no auth required) â€” safe for pricing pages,
...
// ---------------------------------------------------------------------------
// Read server function â€” PUBLIC, no auth required
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Mutation server function â€” requires authenticated ADMIN session
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Exported public API â€” single proxy, routes internally based on action type
// ---------------------------------------------------------------------------
