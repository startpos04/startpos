  ...
  return (
    <div className='flex flex-col gap-6 px-4 pb-6 max-w-5xl'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <div>
          <h1 className='text-2xl font-bold tracking-tight'>{hasActiveSub ? 'Change your plan' : 'Choose a plan'}</h1>
          <p className='text-sm text-muted-foreground mt-0.5'>
            {hasActiveSub ? 'Select a plan to go to checkout.' : 'Pick the tier that fits your business. Change or cancel any time.'}
          </p>
        </div>
      </div>
                  ...
                  >
                    ...
                    <CardContent className='flex-1 flex flex-col gap-4'>
                      ...
                      <div className='min-h-[3.5rem]'>
                        ...
                        <p className='text-xs text-muted-foreground mt-0.5'>
                          {interval === 'annual' && plan.monthlyPrice > 0 ? getAnnualSubtext(plan) : plan.monthlyPrice > 0 ? 'billed monthly' : '\u00a0'}
                        </p>
                      </div>
                    ...
                    <CardFooter className='pt-4'>
                      {isCurrent ? (
                        ...
                        <Button className='w-full' variant={isPopular ? 'default' : 'outline'} onClick={() => handleSelect(plan)}>
