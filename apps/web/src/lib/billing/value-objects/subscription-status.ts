 ...
 *
 * SubscriptionStatusVO â€” thin value-object wrapper around the SubscriptionStatus
 ...
 * (TRIAL, ACTIVE, or GRACE_PERIOD â€” operational features still accessible).
 */
...
/**
 * Returns a human-readable label for the status â€” used in banners and admin UI.
 */
