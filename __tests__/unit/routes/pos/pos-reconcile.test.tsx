...
vi.mock('@/lib/mount-manager', () => {
  const MountManagerMock = Object.assign(
    ...
    {
      show: vi.fn().mockImplementation((_Component: any, opts: any) => {
...
beforeEach(() => {
  ...
  vi.clearAllMocks()
  // Re-apply MountManager.show implementation after clearAllMocks wipes it
  vi.mocked(MountManager.show).mockImplementation((_Component: any, opts: any) => {
...
describe('ReconcileNow — authenticated form', () => {
  async function renderAuthenticated() {
    render(<ReconcileNow open={true} onClose={vi.fn()} />)
    // Click authenticate — MountManager.show mock calls onConfirm(ADMIN) immediately
    await act(async () => {
